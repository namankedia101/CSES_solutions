...
bool issubsequence(string& s1, string& s2,ll n,ll m)
{
    ll i = 0, j = 0;
    while (i < n && j < m) {
        if (s1[i] == s2[j])
...
bool check(ll x,ll n,vi &v,ll h){
    ll cnt=0;
...
int main()
{
    ...
    // while(t--){
        ll l=0,r=1,n=1e8,k,mid=0,ans=0,m=5000001,i=0,j=0,c0=0,c1=0,x=0,y=LONG_LONG_MIN,z=LONG_LONG_MIN,MOD=998244353,a=0,b=0,c=0,d=0,e=0,f=0,g,h;                
